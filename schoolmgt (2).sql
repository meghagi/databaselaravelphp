...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2024 at 08:51 AM
...
INSERT INTO `classes` (`class`, `maths`, `science`, `hindi`, `english`, `physics`, `chemistry`) VALUES
(1, '', 'rashmi', '', '', '', ''),
(2, '', '', '', '', '', ''),
(3, '', '', '', '', '', ''),
(4, '', 'rashmi', '', '', '', ''),
...
INSERT INTO `studentmarks` (`name`, `physics`, `chemistry`, `maths`, `science`, `hindi`, `english`) VALUES
('riya', 0, 40, 50, 80, 0, 0),
('kirti', 0, 0, 0, 0, 0, 85),
('tiya', 0, 0, 0, 0, 84, 0),
('jiya', 0, 0, 0, 50, 0, 0);
...
CREATE TABLE `user` (
  ...
  `Role` enum('user','teacher','admin','student','admission') NOT NULL DEFAULT 'user',
  `userimage` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `subject` enum('physics','maths','chemestry') NOT NULL,
...
INSERT INTO `user` (`id`, `city`, `class`, `section`, `country`, `email`, `name`, `Role`, `userimage`, `password`, `subject`, `state`, `rollno`) VALUES
(1, 'Jhansi', '9', '', 'India', 'meghagangwal1201@gmail.com', 'vinode', 'admission', '', 'm123', 'physics', 'Madhya Pradesh', 0),
(5, 'Jhansi', '10', '', 'India', 'giya@gmail.com', 'giya', 'admission', '', 'g125', 'physics', 'Madhya Pradesh', 0),
(9, 'Jhansi', '8', 'A', 'India', 'yash@gmail.com', 'riya', 'student', '', 'o123', 'physics', 'Madhya Pradesh', 101),
(11, '', '10', '', '', 'guoti@gmail.com', 'piyu', 'student', '', 'g123', 'physics', '', 0),
(12, '', '10', '', '', 'geetati@gmail.com', 'kirti', 'student', '', 'g1234', 'physics', '', 0),
(13, 'Dhar', '', '', 'India', 'guoti12@gmail.com', 'rashmi', 'teacher', '', 'g123', 'physics', 'Madhya Pradesh', 0),
(14, '', '7', '', '', 'piyush@gmail.com', '', 'admission', '', 'p123', 'physics', '', 0),
(15, '', '', '', '', 'harshna@gmail.com', '', 'user', '', 'h123', 'physics', '', 0),
(17, '', '', '', '', 'harshi@gmail.com', '', 'user', '', 'h1234', 'physics', '', 0),
(18, '', '6', '', '', 'harshiya@gmail.com', 'jiya', 'student', '', 'h1235', 'physics', '', 0),
(19, '', '9', '', '', 'abc@gmail.com', 'tiya', 'student', '', 'a12', 'physics', '', 0),
(20, '', '', '', '', 'abc1@gmail.com', '', 'user', 'megha26.jpg', 'a123', 'physics', '', 0),
(21, '', '', '', '', 'deepalijhanjhari@gmail.com', '', 'admin', 'anima2.jpeg', 'd123', 'physics', '', 0);
